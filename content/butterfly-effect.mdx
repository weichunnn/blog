...
But [making choices is tough](https://wchun.xyz/blog/why-making-decisions-is-so-difficult#why-is-it-hard), and our brains are not really great at it. That's why we often go into autopilot mode and choose the easiest way out – the choice that has the lowest risk, lowest reward, and requires the least mental capacity to make a decision.
