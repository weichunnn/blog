...
Similar to mending, each relationship is different; there is no universal blueprint or map that can be applied to all. But there is a purpose. Like how a gardener cares for his plants (or [orchids](https://wchun.xyz/blog/planting-orchids)), we care for people by providing them with an environment to thrive in and grow.
